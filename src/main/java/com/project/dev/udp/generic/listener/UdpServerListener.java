...
public interface UdpServerListener {
    ...
    /**
     * FIXME: Description of method {@code onConnectRequest}. Realiza una acción luego de que se obtenga una
    ...
    /**
     * FIXME: Description of method {@code onDisconnectRequest}. Realiza una acción luego de que se obtenga
    ...
    /**
     * FIXME: Description of method {@code onGenericRequest}. Realiza una acción luego de que se obtenga una
     * petición genérica.
     *
    ...
    /**
     * FIXME: Description of method {@code onGenericRequestWithGenericResponse}. Realiza una acción luego de
    ...
    /**
     * FIXME: Description of method {@code onTimeOutRequest}. Realiza una acción luego de que no se pueda
    ...
    /**
     * FIXME: Description of method {@code onConfirmRequest}. Realiza una acción luego de que se obtenga una
